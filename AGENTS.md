...
- Keep parsing and data-model behavior independent of Qt where practical.
...
- Automated tests are not maintained in this project. Do not add them unless the user requests them.
- Verify affected behavior manually before submitting changes.
- For UI changes, launch the app and verify the affected interaction manually.

## Working tree safety

- Create commits periodically after completing and validating a coherent change, without waiting for a separate user request.
