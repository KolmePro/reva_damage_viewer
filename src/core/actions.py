def connect_actions(app):
    ...
    ui.action_disable_filters.triggered.connect(lambda: window.set_all_filters(False))
    ui.action_reset_damage_range.triggered.connect(window.reset_damage_range)
