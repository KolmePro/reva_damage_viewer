...
class MainWindow(QMainWindow):
    ...
    def show_about(self):
        QMessageBox.about(
            ...
            "Подробный разбор боёв Revelation Online по HTML-файлам истории чата, "
            "сохранённым клиентом игры.<br><br>"
            ...
            "разобраться в причинах гибели на арене или поле боя. "
            ...
            "Сравнивайте результаты в сопоставимых условиях.",
        )
