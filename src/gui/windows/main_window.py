...
class MainWindow(QMainWindow):
    ...
    def copy_original_message(self, message: str):
        QApplication.clipboard().setText(message)
        self.ui.statusbar.showMessage("Исходное сообщение скопировано", 3000)
    ...
    def refresh_damage_summary(self):
        ...
        if converted_healing:
            self.ui.label_9.setText("Лечение уроном")
            rate_tooltip = (
                "Количество ОЗ, восстановленных лечением уроном, делённое на время "
                "между первой и последней такой записью. При нулевой длительности показан прочерк."
            )
