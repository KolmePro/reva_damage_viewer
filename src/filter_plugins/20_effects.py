FILTERS = [
    ...
    },
    {
        ...
        "label": "Лечение уроном",
        "group": "Эффекты",
        "description": (
            "Атаки, которые восстанавливают цели здоровье из-за эффекта «Призма» или похожего эффекта.\n"
            "Учитываются отдельно от обычного урона и лечения.\n"
            "Чтобы увидеть их статистику, выделите в таблице только записи лечения уроном."
        ),
